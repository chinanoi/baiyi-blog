...
<div class="page-body">
    <div class="page">
        ...
        <div class="search" ref="search">
            <div class="crumbs">
                <div class="search-box">
                    <label class="label-width margin-top">用户昵称：</label>
                    <el-input v-model="name" placeholder="用户昵称：" class="search-input input-105 margin-right margin-top"></el-input>
        ...
        <!-- 编辑弹框 -->
        <dialog-form @close="close" @dialogSave="dialogSave" operate="edit" ref="editType" title="审核评论" :dialogData="dialogEditData" :dialogShow="dialogEdit"></dialog-form>
    </div>
    <v-footer></v-footer>
</div>
</template>
...
import dialogForm from './sub-components/CommentDialog.vue'
...
export default {
    ...
    methods: {
        ...
        dialogSave(type, obj) {
            ...
            if (type === 'edit') {
                this.$axios.post('/comments/edit', data, {
                        headers: {
        ...
        getData() {
            ...
            this.$axios.post('/comments/list', data, {
                    headers: {
                        Authorization: localStorage.getItem("token")
                    }
                })
        ...
        handleDel(index, obj) {
            common
                ...
                .then((res) => {
                    ...
                    this.$axios.get('/comments/del?id=' + obj.id, {
                            headers: {
                                Authorization: localStorage.getItem("token")
                            }
                        })
