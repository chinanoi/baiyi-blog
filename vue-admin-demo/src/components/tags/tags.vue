...
<div class="page-body">
    <div class="page">
        ...
        <div class="search" ref="search">
            <div class="crumbs">
                <div class="search-box">
                    ...
                    <el-input v-model="name" placeholder="标签名称：" class="search-input input-105 margin-right margin-top"></el-input>
        ...
        <!-- 表格数据 -->
        <div class="container">
            <ctid-table :data="tableData" @handleSelectionChange="handleSelectionChange" @handleSizeChange="handleSizeChange" @handleCurrentChange="handleCurrentChange" @currentChange="currentChange"></ctid-table>
        </div>
        <!-- 添加弹框 -->
        <dialog-form @close="close" @dialogSave="dialogSave" operate="add" title="添加标签" :dialogData="dialogAddData" :dialogShow="dialogAdd"></dialog-form>
        <!-- 编辑弹框 -->
        <dialog-form @close="close" @dialogSave="dialogSave" operate="edit" title="修改标签" :dialogData="dialogEditData" :dialogShow="dialogEdit"></dialog-form>
    </div>
    <v-footer></v-footer>
</div>
</template>
...
import dialogForm from './sub-components/TagsDialog.vue'
        ...
        handleDel(index, obj) {
            common
                ...
                .then((res) => {
                    ...
                    this.$axios.get('/tag/del?id=' + obj.id, {
                            headers: {
                                Authorization: localStorage.getItem("token")
                            }
                        })
